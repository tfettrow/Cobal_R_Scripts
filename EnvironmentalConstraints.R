...
# lateral ankle
cop_from_com_x_model <- lmer(cop_from_com_x_integrated_sym_ONE ~ zone_direction +  (1|subject), data=results, REML = FALSE)
...
# step placement
step_placement_model <- lmer(step_placement_x_sym_ONE ~ zone_direction +  (1|subject), data=results, REML = FALSE)
...
# stimulus response
stimulus_response_model <- lmer(stimulus_response_x_sym_ONE ~ zone_direction +  (1|subject), data=results, REML = FALSE)
anova_stimulus_response_model <- anova(stimulus_response_model)

stimulus_response_model_gender <- lmer(stimulus_response_x_sym_ONE ~ zone_direction +  (1|subject), data=results, REML = FALSE)
anova_stimulus_response_model_gender <- anova(stimulus_response_model)
...
# com max
com_x_inverted_model <- lmer(com_x_inverted_max ~ zone_direction + (1|subject), data=results_long, REML = FALSE)
...
trigger_leg_ankle_eversion_model <- lmer(trigger_leg_ankle_eversion_integrated_singlestance_ONE ~ zone_direction + (1|subject), data=results, REML = FALSE)
...
trigger_leg_peroneous_emg_model <- lmer(trigger_leg_peroneous_integrated_singlestance_ONE ~ zone_direction + (1|subject), data=results, REML = FALSE)
...
trigger_leg_tibialis_anterior_emg_model <- lmer(trigger_leg_tibiant_integrated_singlestance_ONE ~ zone_direction + (1|subject), data=results, REML = FALSE)
...
trigger_leg_knee_rotation_model <- lmer(trigger_leg_knee_rotation_step_end_ONE ~ zone_direction + (1|subject), data=results, REML = FALSE)
...
contra_leg_hip_rotation_model <- lmer(contra_leg_hip_rotation_step_end_ONE ~ zone_direction + (1|subject), data=results, REML = FALSE)
...
contra_leg_hip_adduction_model <- lmer(contra_leg_hip_adduction_step_end_ONE ~ zone_direction + (1|subject), data=results, REML = FALSE)
...
trigger_leg_ankle_dorsiflexion_model <- lmer(trigger_leg_ankle_dorsiflexion_integrated_doublestance_ONE ~ zone_direction + (1|subject), data=results, REML = FALSE)
...
trigger_leg_gastroc_med_emg_model <- lmer(trigger_leg_gastroc_med_integrated_singlestance_ONE ~ zone_direction + (1|subject), data=results, REML = FALSE)
